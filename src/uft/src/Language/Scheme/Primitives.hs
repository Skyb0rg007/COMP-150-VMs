...
prims = HashMap.fromList (map (\p -> (_prim_name p, p)) m) where
    ...
    m =
        ...
        , Prim "not"           "not"            2     False  True    False     True
        , Prim "="             "eq"             3     False  True    False     True
        , Prim "<"             "lt"             3     False  True    False     True
        , Prim ">"             "gt"             3     False  True    False     True
        , Prim "<="            "leq"            3     False  True    False     True
        , Prim "<="            "geq"            3     False  True    False     True
        , Prim "eq?"           "eqq"            3     False  True    False     True
        , Prim "null?"         "nullq"          2     False  True    False     True
