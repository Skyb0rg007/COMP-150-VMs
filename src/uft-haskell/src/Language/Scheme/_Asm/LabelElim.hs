...
module Language.Scheme.Asm.LabelElim
    ( labelElim
    ) where
...
labelElim instrs = do
    ...
    where
        ...
        replace :: Map Text Int -> (Int, DList ObjInstr) -> AsmInstr -> Either Text (Int, DList ObjInstr)
